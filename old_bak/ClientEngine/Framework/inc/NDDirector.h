...
//		返回值：无
		virtual void BeforeDirectorPopScene(NDDirector* director, NDScene* scene, bool cleanScene){}
//		
...
//		返回值：无	
	...
	private:
		...
		void SetDelegate(NDObject* receiver){}hide
		NDObject* GetDelegate(){ return NULL; }hide
