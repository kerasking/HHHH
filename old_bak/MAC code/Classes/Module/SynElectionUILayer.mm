...
void SynElectionUILayer::Initialization()
{
	...
	m_btnElection->SetImage(pool.AddPicture(NDPath::GetImgPathNew("btn_election.png")), false, CGRectZero, true);
	m_btnElection->SetBackgroundPicture(pool.AddPicture(NDPath::GetImgPathNew("btn_bg1.png")), NULL, true, CGRectMake(0, 4, 36, 36), true);
