...
void SocialFigure::Initialization(bool showTutor, bool showOnline/*=true*/, CGSize size/*=CGSizeMake(178, 112)*/)
{
	...
	this->SetBackgroundImage(pool.AddPicture(NDPath::GetImgPathNew("role_bg.png"), size.width, size.height));
	...
	NDPicture *picLvl = pool.AddPicture(NDPath::GetImgPathNew("level_bg.png"));
...
void SocialEleInfo::Initialization(CGRect rect)
{
	...
	this->SetBackgroundImage(NDPicturePool::DefaultPool()->AddPicture(NDPath::GetImgPathNew("attr_role_bg.png"), rect.size.width, rect.size.height), true);
...
void NDSocialCell::Initialization()
{
	...
	m_picOnline = pool.AddPicture(NDPath::GetImgPathNew("online.png"));
	
	m_picOffline = pool.AddPicture(NDPath::GetImgPathNew("offline.png"));
}
...
void SocialPlayerEquip::Initialization(int lookface)
{
	...
	NDPicture* picRoleBg = pool.AddPicture(NDPath::GetImgPathNew("attr_role_bg.png"), 0, 222);
	...
	m_picRoleBackground = pool.AddPicture(NDPath::GetImgPathNew("role_bg.png"));
