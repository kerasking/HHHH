...
namespace NDEngine 
{
	...
	public:
		...
		void MoveToPosition(CGPoint toPos, SpriteSpeed speed = SpriteSpeedStep4, bool moveMap = false); hide
	...
	public:
		...
		void SetRuleID(int rule_id){this->rule_id=rule_id;}
		int GetRuleID(){return this->rule_id;}
