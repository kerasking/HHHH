...
namespace NDEngine
{
	#define RING_IMAGE		([[NSString stringWithFormat:@"%s", NDPath::GetImgPath("ui_ring.png")] UTF8String])
	#define SHADOW_IMAGE	([[NSString stringWithFormat:@"%s", NDPath::GetImgPath("shadow.png")] UTF8String])
	#define BIG_SHADOW_IMAGE ([[NSString stringWithFormat:@"%s", NDPath::GetImgPath("shadowBig.png")] UTF8String])
	...
	public:
		...
		int GetPetStandAction(){return this->pet_stand_action;}
		int GetPetWalkAction(){return this->pet_run_action;}
		int GetPetAccLevel(){return this->acc_level;}
		int GetPetLookface(){return this->pet_lookface;}
	protected:	
