...
namespace NDEngine
{
	...
	public:
        ...
        void ProcessLoginSuc(NDTransData& data);
        
        void ProcessTempCredential(NDTransData& data);
	...
	public:
		...
		// 好友相关
		bool isFriendMax() {
			return this->m_mapFriend.size() >= MAX_FRIEND_NUM;
		}
