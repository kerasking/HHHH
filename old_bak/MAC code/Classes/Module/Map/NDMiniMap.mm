...
Radar::Radar() : m_role(NDPlayer::defaultHero())
{
	...
	m_miniTaskPic->Initialization(NDPath::GetImgPath("mini_quest.png"));
...
void NDMiniMap::Initialization()
{
	...
	imgRadar->SetPicture(NDPicturePool::DefaultPool()->AddPicture(NDPath::GetImgPathBattleUI("radar.png"), false), true);
	...
	m_btnMap->SetImage(NDPicturePool::DefaultPool()->AddPicture(NDPath::GetImgPathBattleUI("show_map.png"), false), true, CGRectMake(4, 4, 30, 30), true);
	...
	m_btnShrink->SetImage(NDPicturePool::DefaultPool()->AddPicture(NDPath::GetImgPathBattleUI("shrink_map.png"), false), false, CGRectMake(0, 0, 0, 0), true);
