...
void PlayerHead::Initialization(bool bBattle)
{
	...
	pic->Initialization(NDPath::GetImgPathBattleUI("rolebackground.png"));
	...
	pic = new NDPicture;
	pic->Initialization(NDPath::GetImgPathBattleUI("hp_block.png"), 0, 0);
	...
	pic = new NDPicture;
	pic->Initialization(NDPath::GetImgPathBattleUI("mp_block.png"), 0, 0);
	...
	pic = new NDPicture;
	pic->Initialization(NDPath::GetImgPathBattleUI("battlehp.png"));
	...
	pic = new NDPicture;
	pic->Initialization(NDPath::GetImgPathBattleUI("battlemp.png"));
...
void PetHead::Initialization(Fighter* pet)
{
	...
	NDPicture* pic = new NDPicture;
	pic->Initialization(NDPath::GetImgPathBattleUI("eudemonbackground.png"));
...
void PlayerHeadInMap::Initialization()
{
	...
	if (m_role) {
		...
		NDPicture* pic = new NDPicture;
		pic->Initialization(NDPath::GetImgPathBattleUI("scenehandletorole.png"));
		...
		imgPlayerHeadBg->Initialization();
		pic = new NDPicture;
		pic->Initialization(NDPath::GetImgPathBattleUI("scenerolebg.png"));
...
void TargetHeadInMap::Initialization()
{
	...
	imgHeadBg->Initialization();
	NDPicture* pic = new NDPicture;
	pic->Initialization(NDPath::GetImgPathBattleUI("scenetargetbg.png"));
	imgHeadBg->SetPicture(pic, true);
	...
	pic = new NDPicture;
	pic->Initialization(NDPath::GetImgPath("bg.png"));
...
void TeamRoleButton::Initialization()
{
	...
	NDUIImage* imgHeadBg = new NDUIImage;
	imgHeadBg->Initialization();
	NDPicture* pic = pool.AddPicture(NDPath::GetImgPathNew("team_role_back.png"));
	imgHeadBg->SetPicture(pic, true);
