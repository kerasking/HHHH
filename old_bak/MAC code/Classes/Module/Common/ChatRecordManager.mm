...
{
    TICK_ANALYST(ANALYST_ChatRecord);	
	NDUINode::draw();	
	if (this->IsVisibled()) 
	{
...
void ChatRecordManager::CreatePictures()
{
	...
	m_picAllGold = NDPicturePool::DefaultPool()->AddPicture(NDPath::GetImgPath("titles.png"));
	m_picAllGold->Cut(CGRectMake(300, 40, FontWidth, FontHeight));
	
	m_picWorldGold = NDPicturePool::DefaultPool()->AddPicture(NDPath::GetImgPath("titles.png"));
	m_picWorldGold->Cut(CGRectMake(300, 60, FontWidth, FontHeight));
	
	m_picSectionGold = NDPicturePool::DefaultPool()->AddPicture(NDPath::GetImgPath("titles.png"));
	m_picSectionGold->Cut(CGRectMake(300, 80, FontWidth, FontHeight));
	
	m_picQueueGold = NDPicturePool::DefaultPool()->AddPicture(NDPath::GetImgPath("titles.png"));
	m_picQueueGold->Cut(CGRectMake(300, 100, FontWidth, FontHeight));
	
	m_picArmyGold = NDPicturePool::DefaultPool()->AddPicture(NDPath::GetImgPath("titles.png"));
	m_picArmyGold->Cut(CGRectMake(300, 120, FontWidth, FontHeight));
	
	m_picSecretGold = NDPicturePool::DefaultPool()->AddPicture(NDPath::GetImgPath("titles.png"));
	m_picSecretGold->Cut(CGRectMake(300, 140, FontWidth, FontHeight));
	
	m_picSystemGold = NDPicturePool::DefaultPool()->AddPicture(NDPath::GetImgPath("titles.png"));
	m_picSystemGold->Cut(CGRectMake(300, 160, FontWidth, FontHeight));
	
	//to do create Red pictures
	m_picAllRed = NDPicturePool::DefaultPool()->AddPicture(NDPath::GetImgPath("titles.png"));
	m_picAllRed->Cut(CGRectMake(280, 40, FontWidth, FontHeight));
	
	m_picWorldRed = NDPicturePool::DefaultPool()->AddPicture(NDPath::GetImgPath("titles.png"));
	m_picWorldRed->Cut(CGRectMake(280, 60, FontWidth, FontHeight));
	
	m_picSectionRed = NDPicturePool::DefaultPool()->AddPicture(NDPath::GetImgPath("titles.png"));
	m_picSectionRed->Cut(CGRectMake(280, 80, FontWidth, FontHeight));
	
	m_picQueueRed = NDPicturePool::DefaultPool()->AddPicture(NDPath::GetImgPath("titles.png"));
	m_picQueueRed->Cut(CGRectMake(280, 100, FontWidth, FontHeight));
	
	m_picArmyRed = NDPicturePool::DefaultPool()->AddPicture(NDPath::GetImgPath("titles.png"));
	m_picArmyRed->Cut(CGRectMake(280, 120, FontWidth, FontHeight));
	
	m_picSecretRed = NDPicturePool::DefaultPool()->AddPicture(NDPath::GetImgPath("titles.png"));
	m_picSecretRed->Cut(CGRectMake(280, 140, FontWidth, FontHeight));
	
	m_picSystemRed = NDPicturePool::DefaultPool()->AddPicture(NDPath::GetImgPath("titles.png"));
	m_picSystemRed->Cut(CGRectMake(280, 160, FontWidth, FontHeight));
	
	//to do create Chat Pictures
	m_picChatGold = NDPicturePool::DefaultPool()->AddPicture(NDPath::GetImgPath("titles.png"));
	m_picChatGold->Cut(CGRectMake(0, 0, 80, 20));
	
	m_picChatRed = NDPicturePool::DefaultPool()->AddPicture(NDPath::GetImgPath("titles.png"));
