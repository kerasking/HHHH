...
void NDUIItemButton::Initialization()
{
	...
	this->SetBackgroundPicture(pool.AddPicture(NDPath::GetImgPathNew("bag_bagitem.png")), NULL, false, CGRectZero, true);
	
	this->SetFocusImage(pool.AddPicture(NDPath::GetImgPathNew("bag_bagitem_sel.png")), false, CGRectZero, true);
