...
void QuickInteraction::Initialization()
{
	...
	imgFirstBg->SetPicture(pool->AddPicture(NDPath:: GetImgPathBattleUI("quick_bar_bg.png"), false), true);
	...
	m_btnPlayerBag->SetBackgroundPicture(pool->AddPicture(NDPath:: GetImgPathBattleUI("itemchildback.png"), true), NULL, false, CGRectZero, true);
	m_btnPlayerBag->SetImage(pool->AddPicture(NDPath::GetImgPathNew("bagicon.png"), true), false, CGRectMake(0, 0, 0, 0), true);
	...
	m_btnSystem->SetBackgroundPicture(pool->AddPicture(NDPath:: GetImgPathBattleUI("itemchildback.png"), true), NULL, false, CGRectZero, true);
	m_btnSystem->SetImage(pool->AddPicture(NDPath::GetImgPathNew("systemicon.png"), true), false, CGRectZero, true);
	...
	m_btnMail->SetBackgroundPicture(pool->AddPicture(NDPath:: GetImgPathBattleUI("itemchildback.png"), true), NULL, false, CGRectZero, true);
	m_btnMail->SetImage(pool->AddPicture(NDPath:: GetImgPathBattleUI("mail.png"), true), false, CGRectMake(0, 0, 0, 0), true);
	...
	m_btnMainUiBack->SetBackgroundPicture(pool->AddPicture(NDPath:: GetImgPathBattleUI("itemchildback.png"), true), NULL, false, CGRectZero, true);
	m_btnMainUiBack->SetImage(pool->AddPicture(NDPath::GetImgPathNew("main_ui_back.png"), true), false, CGRectMake(0, 0, 0, 0), true);
	...
	m_btnMainUiReset->SetBackgroundPicture(pool->AddPicture(NDPath:: GetImgPathBattleUI("itemchildback.png"), true), NULL, false, CGRectZero, true);
	m_btnMainUiReset->SetImage(pool->AddPicture(NDPath::GetImgPathNew("battlefield.png"), true), false, CGRectMake(0, 0, 0, 0), true);
	...
	m_btnViewInfo->SetBackgroundPicture(pool->AddPicture(NDPath:: GetImgPathBattleUI("itemchildback.png"), true), NULL, false, CGRectZero, true);
	m_btnViewInfo->SetImage(pool->AddPicture(NDPath:: GetImgPathBattleUI("treasure_hunt.png"), true), false, CGRectMake(0, 0, 0, 0), true);
	...
	m_btnPrivateTalk->SetBackgroundPicture(pool->AddPicture(NDPath:: GetImgPathBattleUI("itemchildback.png"), true), NULL, false, CGRectZero, true);
	m_btnPrivateTalk->SetImage(pool->AddPicture(NDPath:: GetImgPathBattleUI("private_talk.png"), true), false, CGRectMake(0, 0, 0, 0), true);
	...
	imgSecondBg->SetPicture(pool->AddPicture(NDPath:: GetImgPathBattleUI("quick_bar_bg2.png"), false), true);
	imgSecondBg->SetFrameRect(CGRectMake(0, 0, 329, 75));
	m_secondBarLayer->AddChild(imgSecondBg);
	
	m_picEmptyBtn = pool->AddPicture(NDPath:: GetImgPathBattleUI("btn_icon.png"));
	m_picInviteTeam = pool->AddPicture(NDPath:: GetImgPathBattleUI("invite_team.png"));
	m_picJoinTeam = pool->AddPicture(NDPath:: GetImgPathBattleUI("join_team.png"));
	m_picLeftTeam = pool->AddPicture(NDPath:: GetImgPathBattleUI("left_team.png"));
	m_picAddFriend = pool->AddPicture(NDPath:: GetImgPathBattleUI("add_friend.png"));
	m_picReherse = pool->AddPicture(NDPath:: GetImgPathBattleUI("reherse.png"));
	m_picWatchBattle = pool->AddPicture(NDPath:: GetImgPathBattleUI("watch_battle.png"));
	m_picInviteSyn = pool->AddPicture(NDPath:: GetImgPathBattleUI("invite_syn.png"));
	m_picBaiShi = pool->AddPicture(NDPath:: GetImgPathBattleUI("baishi.png"));
	m_picShouTu = pool->AddPicture(NDPath:: GetImgPathBattleUI("shoutu.png"));
	m_picShowVendor = pool->AddPicture(NDPath:: GetImgPathBattleUI("show_vendor.png"));
	
	m_picAssignTeamLeader = pool->AddPicture(NDPath:: GetImgPathBattleUI("assign_team_leader.png"));
	m_picDismissTeam = pool->AddPicture(NDPath:: GetImgPathBattleUI("dismiss_team.png"));
	m_picCloseTeam = pool->AddPicture(NDPath:: GetImgPathBattleUI("close_team.png"));
	m_picOpenTeam = pool->AddPicture(NDPath:: GetImgPathBattleUI("open_team.png"));
	m_picKickOutTeam = pool->AddPicture(NDPath:: GetImgPathBattleUI("kickout_team.png"));
	
	m_picTrade = pool->AddPicture(NDPath:: GetImgPathBattleUI("trade.png"));
	m_picPk = pool->AddPicture(NDPath:: GetImgPathBattleUI("PK.png"));
	
	m_picSysSet = pool->AddPicture(NDPath::GetImgPathNew("quickfunc_system.png"));
	m_picSysBackToMenu = pool->AddPicture(NDPath::GetImgPathNew("main_ui_back.png"));
	m_picSysReset = pool->AddPicture(NDPath::GetImgPathNew("main_ui_reset.png"));
	...
	m_btnSwitch->SetImage(NDPicturePool::DefaultPool()->AddPicture(NDPath:: GetImgPathBattleUI("refresh_new.png"), true), false, CGRectMake(0, 0, 0, 0), true);
