...
void ItemFocus::draw()
{
    TICK_ANALYST(ANALYST_ItemFocus);	
	NDUINode::draw();
	Update();
}
...
void ItemFocus::Initialization()
{
	...
	m_picFocus = NDPicturePool::DefaultPool()->AddPicture(NDPath::GetImgPath("chosekuang.png"));
	m_picFocusMirror = NDPicturePool::DefaultPool()->AddPicture(NDPath::GetImgPath("chosekuang.png"));
