...
void NewRegisterAccountScene::Initialization()
{
	...
	NDPicture *picCommit = picpool.AddPicture(NDPath::GetImgPathNew("create&login_text.png"));
	...
	picCommit = picpool.AddPicture(NDPath::GetImgPathNew("create&login_text.png"));
