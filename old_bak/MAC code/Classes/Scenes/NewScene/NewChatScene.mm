...
NewChatScene::NewChatScene() {
	...
	m_layerBg->SetBackgroundImage(pool.AddPicture(NDPath::NDPath::GetImgPathNew("chat_bg.png")), true);
	...
	btn->SetImage(pool.AddPicture(NDPath::NDPath::GetImgPathNew("dlgfull_close_normal.png")), false, CGRectZero, true);
	...
	NDPicture* pic = pool.AddPicture(NDPath::NDPath::GetImgPathNew("chat_btn.png"), true);
	pic->SetReverse(true);
	btn = new NDUIButton;
	btn->Initialization();
	...
	pic = pool.AddPicture(NDPath::NDPath::GetImgPathNew("chat_btn.png"), true);
	pic->SetReverse(true);
	btn = new NDUIButton;
	btn->Initialization();
	btn->SetFrameRect(CGRectMake(startX, startY, 46, 42));
	...
	pic = pool.AddPicture(NDPath::NDPath::GetImgPathNew("chat_channel_normal.png"), true);
	btn = new NDUIButton;
	btn->Initialization();
	...
	btn = new NDUIButton;
	btn->Initialization();
	pic = pool.AddPicture(NDPath::NDPath::GetImgPathNew("text_back.png"), 359, 25);
	btn->SetImage(pic, false, CGRectMake(0, 0, 0, 0), true);
	pic = pool.AddPicture(NDPath::NDPath::GetImgPathNew("text_back_focus.png"), 359, 25); 
	...
	pic = pool.AddPicture(NDPath::NDPath::GetImgPathNew("channel_sel.png"), true);
	btn = new NDUIButton;
	btn->Initialization();
	...
	btn = new NDUIButton;
	btn->Initialization();
	pic = pool.AddPicture(NDPath::NDPath::GetImgPathNew("send_normal.png"), 88, 32);
	btn->SetImage(pic, false, CGRectMake(0, 0, 0, 0), true);
	pic = pool.AddPicture(NDPath::NDPath::GetImgPathNew("send_touch_down.png"), 88, 32); 
...
void NewChatScene::ActiveChannel(NDUIButton* btnChannel)
{
	...
	if (m_btnCurChannel) {
		m_btnCurChannel->SetImage(NDPicturePool::DefaultPool()->AddPicture(NDPath::NDPath::GetImgPathNew("chat_channel_normal.png")), true, CGRectMake(14, 0, 47, 32), true);
	}
	m_btnCurChannel = btnChannel;
	m_btnCurChannel->SetImage(NDPicturePool::DefaultPool()->AddPicture(NDPath::NDPath::GetImgPathNew("chat_channel_focus.png")), false, CGRectZero, true);
}
...
section->AddCell(btnChannel)
	...
	tlChannel->SetBackgroundImage(NDPicturePool::DefaultPool()->AddPicture(NDPath::NDPath::GetImgPathNew("choose_chat_channel.png")), true);
...
ChatFaceOrItemLayer::ChatFaceOrItemLayer()
{
	...
	m_layerFace->SetBackgroundImage(NDPicturePool::DefaultPool()->AddPicture(NDPath::NDPath::GetImgPathNew("bag_bag_bg.png"), 265, 265, false), true);
	...
	for (int index = 0; index < 25; index++) 
	{
		...
		NDPicture* pic = NDPicturePool::DefaultPool()->AddPicture(NDPath::GetImgPath("face.png"));				
		int row = index / 5;
		int col = index % 5;
