...
void NewPlayerTask::Initialization()
{
	...
	NDPicture *picClose = NDPicturePool::DefaultPool()->AddPicture(NDPath::GetImgPathNew("task_delete.png"));
	...
	scrollLayer->SetBackgroundImage( pool.AddPicture(NDPath::GetImgPathNew("attr_role_bg.png"), 194, 184), true);
	...
	m_picTaskDone = pool.AddPicture(NDPath::GetImgPathBattleUI("TaskDone.png"), false);
...
DailyTask::DailyTask()
{
	m_picTaskDone = NDPicturePool::DefaultPool()->AddPicture(NDPath::GetImgPathBattleUI("TaskDone.png"), false);
