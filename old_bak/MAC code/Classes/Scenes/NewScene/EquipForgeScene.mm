...
void EquipForgeScene::Initialization()
{
	...
	imgBg->SetPicture(pool.AddPicture(NDPath::GetImgPathNew("bag_left_bg.png")), true);
	...
	m_btnConfirm->SetBackgroundPicture(pool.AddPicture(NDPath::GetImgPathNew("bag_btn_normal.png")),
