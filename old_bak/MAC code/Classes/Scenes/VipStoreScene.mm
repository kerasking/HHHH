...
void StoreTabLayer::Initialization()
{
	...
	m_picLeft[eSel] = NDPicturePool::DefaultPool()->AddPicture(NDPath::GetImgPath("tab_left_selected.png"));
	m_picLeft[eUnSel] = NDPicturePool::DefaultPool()->AddPicture(NDPath::GetImgPath("tab_left_unselected.png"));
	
	m_picRight[eSel] = NDPicturePool::DefaultPool()->AddPicture(NDPath::GetImgPath("tab_right_selected.png"));
	m_picRight[eUnSel] = NDPicturePool::DefaultPool()->AddPicture(NDPath::GetImgPath("tab_right_unselected.png"));
	
	m_picMid[eSel] = NDPicturePool::DefaultPool()->AddPicture(NDPath::GetImgPath("tab_middle_selected.png"));
	m_picMid[eUnSel] = NDPicturePool::DefaultPool()->AddPicture(NDPath::GetImgPath("tab_middle_unselected.png"));
}
...
void StoreItemLayer::Initialization(VipItem* vipitem)
{
	...
	m_picMoney = NDPicturePool::DefaultPool()->AddPicture(NDPath::GetImgPath("emoney.png"));
...
void VipStoreScene::Initialization()
{
	...
	m_picTitle = NDPicturePool::DefaultPool()->AddPicture(NDPath::GetImgPath("vip_store.png"));
