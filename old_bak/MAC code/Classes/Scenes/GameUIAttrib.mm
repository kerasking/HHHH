...
void AttrInfo::Initialization()
{
	...
	NDPicture* picBagLeftBg = NDPicturePool::DefaultPool()->AddPicture(NDPath::GetImgPathNew("bag_left_bg.png"));
...
void GameUIAttrib::Initialization()
{
	...
	NDPicture* picRoleBg = pool.AddPicture(NDPath::GetImgPathNew("attr_role_bg.png"));
	...
	{
		case CAMP_TYPE_TANG:
			picCamp = pool.AddPicture(NDPath::GetImgPathNew("tang.png"));
			break;
		case CAMP_TYPE_SUI:
			picCamp = pool.AddPicture(NDPath::GetImgPathNew("sui.png"));
			break;
		case CAMP_TYPE_TU:
			picCamp = pool.AddPicture(NDPath::GetImgPathNew("tu.png"));
			break;
		default:
			break;
	}
	...
	*/
	...
	NDPicture *picFrameMoney = pool.AddPicture(NDPath::GetImgPathNew("money_bg.png"), 197, 45);
