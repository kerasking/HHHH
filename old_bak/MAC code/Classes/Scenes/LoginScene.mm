...
void LoginScene::Initialization(bool changeServer/*=false*/)
{
	...
	m_menuLayer->SetBackgroundImage(NDPath::GetImgPathNew("login_background.png"));
	...
	layerGame->SetBackgroundImage(NDPath::GetImgPathNew("login_game_bg.png"));
	m_menuLayer->AddChild(layerGame);
	
	NDPicture *login = picpool.AddPicture(NDPath::GetImgPathNew("create&login_text.png"));
	...
	NDPicture *account = picpool.AddPicture(NDPath::GetImgPathNew("create&login_text.png"));
	NDPicture *password = picpool.AddPicture(NDPath::GetImgPathNew("create&login_text.png"));
	...
	NDPicture* picList = picpool.AddPicture(NDPath::GetImgPathNew("list_btn.png"));
	...
	NDPicture *picBind = picpool.AddPicture(NDPath::GetImgPathNew("bind_phone_btn.png"));
	...
	m_btnBind->SetTouchDownImage(picpool.AddPicture(NDPath::GetImgPathNew("bind_phone_btn_fcs.png")), false, CGRectZero, true);
	...
	*/
	...
	m_cbSavePassword->Initialization(
						picpool.AddPicture(NDPath::GetImgPathNew("check_sel.png")),
						picpool.AddPicture(NDPath::GetImgPathNew("check_unsel.png")),
						true);
	...
	for (int i = 0; i < 3; i++) 
	{
		NDPicture *pic = picpool.AddPicture(NDPath::GetImgPathNew("login_text.png"));
	...
	NDPicture *picForgot = picpool.AddPicture(NDPath::GetImgPathNew("get_pass_btn.png"));
	...
	m_btnForgot->SetTouchDownImage(picpool.AddPicture(NDPath::GetImgPathNew("get_pass_btn_fcs.png")), false, CGRectZero, true);
