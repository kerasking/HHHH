...
public:
	...
	void SetDisplayResolution(DISPLAY_RESOLUTION e)
	{
		if (DISPLAY_RESOLUTION_BEGIN > e  
			|| DISPLAY_RESOLUTION_END <= e)
		{
			return;
		}
		display_resolution	= e;
	}
private:
	std::string GetValKeyStr(const char* str);
