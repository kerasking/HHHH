...
#define IMAGE_RADIO_BUTTON_ON [NSString stringWithFormat:@"%s", NDPath::GetImgPath("radio-on.png")]
#define IMAGE_RADIO_BUTTON_OFF [NSString stringWithFormat:@"%s", NDPath::GetImgPath("radio-off.png")]
