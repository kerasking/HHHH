...
namespace NDEngine
{
	...
	{		
		...
		this->SetBackgroundImage(pool.AddPicture(NDPath::GetImgPathNew(m_bFullScreen ? "dlgfull_bg.png" : "dlg_bg.png")), true);	
		...
		m_btnClose->SetImage(pool.AddPicture(NDPath::GetImgPathNew(m_bFullScreen ? "dlgfull_close_normal.png" : "dlg_close_normal.png")), 
							false, CGRectZero, true);
		m_btnClose->SetTouchDownImage(pool.AddPicture(NDPath::GetImgPathNew(m_bFullScreen ? "dlgfull_close_click.png" : "dlg_close_click.png")),
									  false, CGRectZero, true);
		...
		if (!m_bFullScreen)
		{
			...
			m_contentScroll->SetBackgroundImage(pool.AddPicture(NDPath::GetImgPathNew("dlg_content.png"), 
			...
			if (hasBtn)
			{
				...
				m_btnConfirm->SetImage(pool.AddPicture(NDPath::GetImgPathNew("dlg_btn_normal.png"), m_sizeBtnNotFullScr.width, m_sizeBtnNotFullScr.height), 
									   false, CGRectZero, true);
				m_btnConfirm->SetTouchDownImage(pool.AddPicture(NDPath::GetImgPathNew("dlg_btn_click.png"), m_sizeBtnNotFullScr.width, m_sizeBtnNotFullScr.height), 
												false, CGRectZero, true);
	...
	void NDUIDialog::OnButtonClick(NDUIButton* button)
	{
		...
		{
            ScriptMgrObj.excuteLuaFunc("PlayEffectSound", "Music",0);
