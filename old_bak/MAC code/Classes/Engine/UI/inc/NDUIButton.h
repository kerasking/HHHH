...
//		返回值：无
		void SetTouchDownColor(ccColor4B touchDownColor);
//		
//		函数：SetFocusColor
//		作用：设置焦点时的颜色，调用该方法将使SetFocusRimImage和SetFocusNormal方法失效
//		参数：focusColor颜色值rgba
//		返回值：无
		void SetFocusColor(ccColor4B focusColor);		
//		
//		函数：SetFocusRimImage
...
//		返回值：
		...
		void SetFocusFontColor(ccColor4B focusFontColor);
//		
//		函数：GetFontColor
//		作用：获取按钮的字体颜色
//		参数：无
...
//		返回值：字体大小
		...
		void SetText(const char* text1, 
					 ...
					 ccColor4B color1 = ccc4(11, 34, 18, 255),
					 ccColor4B color2 = ccc4(11, 34, 18, 255),
		...
		void SetNormalImageColor(ccColor4B color) { m_normalImageColor = color; }
	...
	protected:
		...
		NDUILabel* m_title;	
		ccColor4B m_touchDownColor;
		ccColor4B m_focusColor;
		ccColor4B m_backgroundColor;
		ccColor4B m_normalImageColor;
		bool m_touched;
		bool m_longTouched;
		bool m_framed;
		...
		CGRect m_customRect, m_touchDownImgCustomRect, m_customFocusImageRect, m_customDisImageRect;
		...
		ccColor4B m_colorTitle, m_colorFocusTitle;
