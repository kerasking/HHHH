...
#define MAP_SCALE  (0.5f*NDDirector::DefaultDirector()->GetScaleFactor())
/*
...
//	int				_roadBlockY;
	...
	NSMutableArray  *_needdownloadimgs;
}
@property (nonatomic, copy)NSString *file;						//地图文件名
...
@property (nonatomic, assign, readonly)bool bReload;				//缺少图片需要重新载入
...
@property (nonatomic, readwrite)NSArray *needdownloadimgs;		//待下载图片
