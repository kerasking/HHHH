...
//		返回值：无
		void Initialization(const char* sprFile, bool bFaceRight = true); hide
		void Initialization(const char* sprFile, ISpriteEvent* pEvent, bool bFaceRight); hide
//		
//		函数：OnDrawBegin
//		作用：该方法在精灵绘制之前被框架调用
//		参数：bDraw精灵是否显示在屏幕上
...
//		返回值：无
	...
	public:
		...
		//////////////////////////////////////////////////////////////////////
		virtual CCTexture2D *GetWeaponImage();
	...
	protected:
		...
		void reloadAni(const char* sprFile);
	protected:
		...
		*m_faqiImage, *m_cloakImage, *m_doubleHandSpearImage,*m_weaponImage;		
