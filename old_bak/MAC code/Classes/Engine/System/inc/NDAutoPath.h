...
namespace NDEngine
{
	...
	public:
		 ...
		 */
		bool autoFindPath(CGPoint fromPosition, CGPoint toPosition, NDMapLayer* mapLayer, int step, bool mustarrive=false, bool ignoreMask=false);
	...
	private:
		...
		void GetPath(NDMapLayer* mapLayer);
