...
public: // init and destory
	...
	static bool Init3DEx(HEAGLDRAWABLE hEaglDrawable, const char* pszAppPath, bool bUseStencilBuffer);
...
public:	// 3d relative
	...
	static bool ChangeViewportResolution(DWORD dwWidth, DWORD dwHeight, bool bDeviceOrLogic);
