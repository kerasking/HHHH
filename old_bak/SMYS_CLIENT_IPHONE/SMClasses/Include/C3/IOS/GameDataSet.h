...
public:
	...
	// 强行卸载某个3DTexture资源
	virtual bool Reload3DTextureResource(OBJID idTexture) = 0;
	...
	// 使CGameDataSet::GetDataAni在找不到Ani的Title定义时,返回该Ani文件里名为[__Default]的CAni.
	virtual void EnableReturnDefaultAni(bool bEnable) = 0;

	virtual void SetResourceDefaultLife(DWORD dw3DObjLife, DWORD dw3DMotionLife, DWORD dw3DTextureLife, DWORD dw3DEffectLife) = 0;
};
