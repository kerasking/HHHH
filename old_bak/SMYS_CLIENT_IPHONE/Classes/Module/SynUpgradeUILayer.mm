...
void SynUpgradeUILayer::Initialization()
{
	...
	imgBg->SetPicture(pool.AddPicture(GetImgPathNew("cell_mask.png"), 457, 20), true);
	...
	btnUpgrade->SetImage(pool.AddPicture(GetImgPathNew("syn_upgrade.png")), false, CGRectZero, true);
	this->AddChild(btnUpgrade);
	btnUpgrade->SetBackgroundPicture(pool.AddPicture(GetImgPathNew("btn_bg1.png")), NULL, true, CGRectMake(6, 0, 38, 38), true);
}
