...
void AssignJobLayer::Initialization()
{
	...
	this->SetBackgroundImage(NDPicturePool::DefaultPool()->AddPicture(GetImgPathNew("attr_role_bg.png")), true);
	
	NDUIImage* infoTitle = new NDUIImage;
	infoTitle->Initialization();
	infoTitle->SetPicture(NDPicturePool::DefaultPool()->AddPicture(GetImgPathNew("farmrheadtitle.png")), true);
	...
	btn->SetImage(NDPicturePool::DefaultPool()->AddPicture(GetImgPathNew("btn_confirm.png")), false, CGRectZero, true);
