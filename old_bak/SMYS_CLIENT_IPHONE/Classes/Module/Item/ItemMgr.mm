...
EnhancedObj* ItemMgr::QueryEnhancedType(int idEnhancedType)
{
	...
	if (it != m_mapEnhancedType.end()) {
		...
		if (itIndex != m_mapEnhancedTypeIndex.end())
		{
			...
			NSString *type = [NSString stringWithFormat:@"%s", GetResPath("enhancedtype.ini")];
...
NDItemType* ItemMgr::QueryItemType(OBJID idItemType)
{
	...
	if (it != m_mapItemType.end()) {
		...
		{
			//NSString *resPath = [NSString stringWithUTF8String:NDPath::GetResourcePath().c_str()];
			NSString *itemtype = [NSString stringWithFormat:@"%s", GetResPath("itemtype.ini")];
...
{
	//NSString *resPath = [NSString stringWithUTF8String:NDPath::GetResourcePath().c_str()];
	NSString *itemtypeTable = [NSString stringWithFormat:@"%s", GetResPath("itemtypeTable.ini")];
...
{
	//NSString *resPath = [NSString stringWithUTF8String:NDPath::GetResourcePath().c_str()];
	NSString *itemtypeTable = [NSString stringWithFormat:@"%s", GetResPath("enhancedtypeTable.ini")];
	NSInputStream *stream  = [NSInputStream inputStreamWithFileAtPath:itemtypeTable];
...
{
	//NSString *resPath = [NSString stringWithUTF8String:NDPath::GetResourcePath().c_str()];
	NSString *itemAdditionTable = [NSString stringWithFormat:@"%s", GetResPath("addition.ini")];
