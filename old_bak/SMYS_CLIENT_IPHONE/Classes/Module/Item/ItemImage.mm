...
NDPicture* ItemImage::GetItem(int iIndex, bool gray/*=false*/, bool smallicon/*=false*/)
{
	...
	NDPicture *res = NDPicturePool::DefaultPool()->AddPicture((smallicon ? GetImgPathBattleUI("item_small.png") : GetSMImgPath("mix/mix_goods.png") ) , true);
	if (!res)
	{
		return NULL;
	}
...
NDPicture* ItemImage::GetPinZhiPic(int iItemType, bool smallicon/*=false*/)
{
	...
	res = NDPicturePool::DefaultPool()->AddPicture(GetImgPathBattleUI(smallicon ? "item_small.png" : "items.png"), true);
	if (!res)
	{
		return NULL;
	}
...
NDPicture* GetSkillIconByIconIndex(int iIconIndex, bool gray/*=false*/)
{
	...
	NDPicture *res = NDPicturePool::DefaultPool()->AddPicture(GetImgPathNew("skillicon.png"), gray);
