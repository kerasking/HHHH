...
void SynListCell::Initialization()
{
	...
	m_picBg = pool.AddPicture(GetImgPathNew("attr_listitem_bg.png"), 430, 23);
	
	this->SetFrameRect(CGRectMake(0, 0, 430, 23));
	
	m_picFocus = pool.AddPicture(GetImgPathNew("selected_item_bg.png"), 430, 0);
...
void SyndicateUILayer::Initialization()
{
	...
	img->Initialization();
	img->SetPicture(pool.AddPicture(GetImgPathNew("bag_bag_bg.png"), 451, 268), true);
	...
	m_btnViewInfo->SetBackgroundPicture(pool.AddPicture(GetImgPathNew("btn_bg1.png")), NULL, true, CGRectMake(3, 3, 38, 38), true);
	m_btnViewInfo->SetImage(pool.AddPicture(GetImgPathBattleUI("view_info.png")), false, CGRectZero, true);
	...
	m_btnApply->SetBackgroundPicture(pool.AddPicture(GetImgPathNew("btn_bg1.png")), NULL, true, CGRectMake(3, 3, 38, 38), true);
	m_btnApply->SetImage(pool.AddPicture(GetImgPathNew("icn_apply.png")), false, CGRectZero, true);
	...
	m_btnPrePage->SetImage(pool.AddPicture(GetImgPathNew("pre_page.png")), true, CGRectMake(0, 4, 36, 31), true);
	m_btnPrePage->SetBackgroundPicture(pool.AddPicture(GetImgPathNew("btn_bg1.png")), NULL, false, CGRectZero, true);
	...
	m_btnNextPage->SetImage(pool.AddPicture(GetImgPathNew("next_page.png")), true, CGRectMake(0, 4, 36, 31), true);
	m_btnNextPage->SetBackgroundPicture(pool.AddPicture(GetImgPathNew("btn_bg1.png")), NULL, false, CGRectZero, true);
