...
void QuickTalkCell::Initialization(const char* pszText, const CGSize& size)
{
	...
	pic->Initialization(GetImgPathBattleUI("chat_icon_sys.png"));
	...
	img->Initialization();
	pic = new NDPicture;
	pic->Initialization(GetImgPathBattleUI("battle_chat_line.png"), 10, 1);
	img->SetPicture(pic, true);
...
void HighlightTip::Initialization() {
	...
	m_picBubble->Initialization(GetImgPath("ui_map.png"), 70, 60);
	...
	NDPicture* pic = NDPicturePool::DefaultPool()->AddPicture(GetImgPath("hp.png"));
	...
	pic = NDPicturePool::DefaultPool()->AddPicture(GetImgPath("mp.png"));
...
//	dieAniGroup=NULL;
	...
	m_picActionWordDef->Initialization(GetImgPath("actionWord.png"));
	...
	m_picActionWordDodge->Initialization(GetImgPath("actionWord.png"));
	m_picActionWordDodge->Cut(CGRectMake(0.0f, 18.0f, 37.0f, 18.0f));
	m_picActionWordFlee->Initialization(GetImgPath("actionWord.png"));
	...
	m_picBaoJi->Initialization(GetImgPath("bo.png"));
	//	
