...
void OtherPlayerInfoScene::Initialization(NDManualRole* role)
{
	...
	for (int i = eBegin; i < eEnd; i++) 
	{
		...
		if (i == eOtherPlayerInfo) 
		{
			...
			imgLeft->SetPicture(NDPicturePool::DefaultPool()->AddPicture(GetImgPathNew("bag_left_bg.png")), true);
			...
			imgTitle->SetPicture(NDPicturePool::DefaultPool()->AddPicture(GetImgPathNew("title.png")), true);
			...
			m_layerInfo->SetBackgroundImage(NDPicturePool::DefaultPool()->AddPicture(GetImgPathNew("attr_role_bg.png")), true);
			...
			if (role) {
				...
				imgRoleBg->SetPicture(NDPicturePool::DefaultPool()->AddPicture(GetImgPathNew("role_bg.png")), true);
