...
#if ND_MOD
	CCLog( "@@ CCEGLViewProtocol::setDesignResolutionSize(%d, %d, %d), m_fScaleX=%f, m_fScaleY=%f\r\n", 
		(int)width, (int)height, (int) resolutionPolicy, 
			m_fScaleX, m_fScaleY );
#endif
}
...
#if ND_MOD
	CCLog("@@ CCEGLViewProtocol::setFrameSize(%d,%d)\r\n", (int)width, (int)height);
#endif
}
...
#if ND_MOD
	CCLog("@@ CCEGLViewProtocol::setViewPortInPoints(), call glViewport(%d, %d, %d, %d)\r\n",
