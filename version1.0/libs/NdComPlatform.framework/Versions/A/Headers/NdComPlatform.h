...
@property (nonatomic, assign) BOOL shouldRestartApplicationWhenSwitchAccount;	/**< 默认为YES，建议允许用户在程序内注销和切换账号 */
...
#pragma mark -
#pragma mark Phone Account Bind
/**
