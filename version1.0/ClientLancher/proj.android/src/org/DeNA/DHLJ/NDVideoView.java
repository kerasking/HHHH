 ...
 */
public class NDVideoView extends SurfaceView implements MediaPlayerControl
{
	private String TAG = "VideoView";

	private Context mContext;
	private boolean m_bIsTension = false;
	...
	public NDVideoView(Context context)
	{
		super(context);
		mContext = context;
		initVideoView();
	...
	public NDVideoView(Context context, AttributeSet attrs)
	{
	...
	public NDVideoView(Context context, AttributeSet attrs, int defStyle)
	{
