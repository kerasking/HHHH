...
bool TQDelegate::initInstance()
{
    ...
    do 
    {
        ...
        CC_BREAK_IF(! pMainWnd
            || ! pMainWnd->Create(TEXT("神魔永生"), 960, 640));

#endif  // CC_PLATFORM_WIN32

#if (CC_TARGET_PLATFORM == CC_PLATFORM_IOS)

        // OpenGLView initialized in testsTQDelegate.mm on ios platform, nothing need to do here.
		...
		CCEGLView * pMainWnd = new CCEGLView();
		CC_BREAK_IF(! pMainWnd
				|| ! pMainWnd->Create("神魔永生", 480, 320, 480, 320));
...
bool TQDelegate::applicationDidFinishLaunching()
{
    // initialize director
...
void TQDelegate::applicationDidEnterBackground()
{
...
void TQDelegate::applicationWillEnterForeground()
{
