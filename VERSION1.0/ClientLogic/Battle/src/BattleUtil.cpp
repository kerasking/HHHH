...
void assasinSkillAction(Fighter& f)
{
	...
	if (f.m_eLookfaceType == LOOKFACE_MANUAL)
	{
		...
		case 131404:
		case 131408:
			nAction = MANUELROLE_SKILL_ASSASIN_BOW_AREA;
			break;
		case 131201: // ÇÐ¸î
		case 131202: // ¶Û»¯
		case 131203:
			nAction = MANUELROLE_SKILL_ASSASIN_SWORD_SINGLE;
			break;
		case 131001: // Òþ¶Ý
			nAction = MANUELROLE_SKILL_ASSASIN_SWORD_SINGLE;
			break;
		...
		case 131307: // ÁúÓù·Éµ¶
		case 131304: // ¼±ËÙÁÆÉË
			nAction = MANUELROLE_SKILL_WARRIOR_SWORD_AREA;
			break;
		case 131301: // ×·ÐÄ´Ì
		case 131302: // º®¹âÉÁÏÖ
		case 131305: // Ò»ÈÐÆÆ·¨
		case 131306: // ³éµ¶¶øÖÁ
		case 131308: // ÖÂÃüÒ»»÷
			nAction = MANUELROLE_SKILL_ASSASIN_PONIARD_SINGLE;
			break;
		}
	}
	else
	{
		nAction = MONSTER_ATTACK;
		bFaceRight = !bFaceRight;
	}
...
{
	if (f.m_bDefenceAtk)
	{	//Èç¹ûÒÑ¾­ÉèÎª¸ñµ²¶¯×÷£¬ÔòºöÂÔÕâ´Î¶¯×÷ÉèÖÃ
		return;
	}
	NDBaseRole *role = f.GetRole();
