...
public:	
	...
	void SetChatTitle(bool bLeft, std::string title, int nFontSize, int nFontColor);
	
	void SetChatTitleBySpriteKey(bool bLeft, int nKey, int nFontSize, int nFontColor);
	
	void SetChatContent(bool bLeft, std::string content, int nFontSize, int nFontColor);
