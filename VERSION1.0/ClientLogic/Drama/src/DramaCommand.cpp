...
void DramaCommandSprite::InitWithMove(int nKey, int nToPosX, int nToPosY, int nStep)
{
	m_param.nKey						= nKey;
...
void DramaCommandScene::InitWithLoad(std::string centerText, int nFontSize, int nFontColor)
{
	m_param.nKey						= AllocKey();
