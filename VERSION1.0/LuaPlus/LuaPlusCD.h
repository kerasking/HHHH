...
// add by jhzheng 2012.1.19
	template<typename T>
	inline void Push(lua_State* L, T* classptr)
	{
		if (classptr == NULL)
		{
			lua_pushnil(L);
...
// add by jhzheng 2012.2.1
	...
	inline void Push(lua_State* L, T classobj)
	{
		...
		lua_pop(L, 1);
		T* ptrObj = (T *)(lua_newuserdata(L, sizeof(T)));
		*ptrObj = classobj;
		
		//(*(T *)(lua_newuserdata(L, sizeof(T))) = (classobj));
		lua_getfield(L, LUA_REGISTRYINDEX, metaname.c_str());
		lua_setmetatable(L, -2);
	...
	// add by jhzheng 2012.4.20
	inline bool	Match(TypeWrapper<std::string>, lua_State* L, int idx)
	{  return lua_type(L, idx) == LUA_TSTRING;  }

// add by jhzheng 2012.1.19
	template<typename T>
	inline bool	Match(TypeWrapper<T>, lua_State* L, int idx)
	{  return lua_type(L, idx) == LUA_TUSERDATA || lua_type(L, idx) == LUA_TNIL;  }
...
// add by jhzheng 2012.1.19
	template<typename T>
	inline T				Get(TypeWrapper<T>, lua_State* L, int idx)
	{   
...
// add by jhzheng 2012.2.1
	...
	inline T*				Get(TypeWrapper<T*>, lua_State* L, int idx)
	{
		...
		return (T*)lua_unboxpointer(L, idx);  
	}
	...
	struct ReturnSpecialization<void>
	{
		...
		static int Call(Callee& callee, void (Callee::*func)(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11), lua_State* L, int index)
		{
			luaL_argassert(1, index + 0);
			luaL_argassert(2, index + 1);
			luaL_argassert(3, index + 2);
		...
		static int Call(Callee& callee, void (Callee::*func)(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12), lua_State* L, int index)
		{
			luaL_argassert(1, index + 0);
			luaL_argassert(2, index + 1);
			luaL_argassert(3, index + 2);
			...
			(callee.*func)(
						   ...
						   Get(TypeWrapper<P10>(), L, index + 9),
						   Get(TypeWrapper<P11>(), L, index + 10),
						   Get(TypeWrapper<P12>(), L, index + 11)
						   );
			return 0;
		}
	};
	...
	typename P4, typename P5, typename P6, typename P7, typename P8, typename P9, typename P10,
	typename P11>
	int Call(Callee& callee, RT (Callee::*func)(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11), lua_State* L, int index)
	{
		return ReturnSpecialization<RT>::Call(callee, func, L, index);
	}
	...
	int Call(Callee& callee, RT (Callee::*func)(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12), lua_State* L, int index)
	{
		return ReturnSpecialization<RT>::Call(callee, func, L, index);
	}
	...
	int Call(Callee& callee, RT (Callee::*func)(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13), lua_State* L, int index)
	{
		return ReturnSpecialization<RT>::Call(callee, func, L, index);
	}
//	
	...
	int Call(Callee& callee, RT (Callee::*func)(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14), lua_State* L, int index)
	{
		return ReturnSpecialization<RT>::Call(callee, func, L, index);
	}
//	
	...
	int Call(Callee& callee, RT (Callee::*func)(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15), lua_State* L, int index)
	{
		return ReturnSpecialization<RT>::Call(callee, func, L, index);
	}
...
namespace LPCD
{
	...
	public:
		...
		{
 			unsigned char* buffer = GetFirstUpValueAsUserData(L);
			Callee* ptrCallee = (Callee*)GetObjectUserData(L);
			Callee& callee = *ptrCallee;
