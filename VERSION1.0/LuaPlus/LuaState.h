...
class LuaState;
typedef void (*luaplus_ExceptInfoOut) (LuaState *L, const char *exceptinfo);
...
// add by jhzheng 2012.1.19
public:
	void SetExceptInfoOutHandler(luaplus_ExceptInfoOut handler) {
		m_hExceptInfoOut = handler;
	}

	luaplus_ExceptInfoOut GetExceptInfoOutHandler() {
		return m_hExceptInfoOut;
	}
private:
	luaplus_ExceptInfoOut m_hExceptInfoOut;
};
