 ...
 */
int RijndaelInit(Rijndael* rijndael, int mode, int dir, UINT8* key, int keyLen,
		UINT8* initVector);
 ...
 */
int RijndaelBlockEncrypt(Rijndael* rijndael, UINT8 *input, int inputLen,
		UINT8 *outBuffer);
 ...
 */
int RijndaelPadEncrypt(Rijndael* rijndael, UINT8 *input, int inputOctets,
		UINT8 *outBuffer);
 ...
 */
int RijndaelBlockDecrypt(Rijndael* rijndael, UINT8 *input, int inputLen,
		UINT8 *outBuffer);
 ...
 */
int RijndaelPadDecrypt(Rijndael* rijndael, UINT8 *input, int inputOctets,
		UINT8 *outBuffer);
