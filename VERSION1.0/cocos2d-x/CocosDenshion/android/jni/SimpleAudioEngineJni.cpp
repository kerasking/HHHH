...
extern "C"
{
	...
	void preloadBackgroundMusicJNI(const char *path)
	{
		...
		if (!getStaticMethodInfo(methodInfo, "preloadBackgroundMusic",
			"(Ljava/lang/String;)V"))
		{
			return;
		}
	...
	void playBackgroundMusicJNI(const char *path, bool isLoop)
	{
		...
		{
			LOGERROR("Can't get static method----\"playBackgroundMusic\".");
			return;
		}
	...
	void preloadEffectJNI(const char *path)
	{
		...
		if (!getStaticMethodInfo(methodInfo, "preloadEffect",
			"(Ljava/lang/String;)V"))
		{
			return;
		}
	...
	void unloadEffectJNI(const char* path)
	{
		...
		if (!getStaticMethodInfo(methodInfo, "unloadEffect",
			"(Ljava/lang/String;)V"))
		{
			return;
		}
