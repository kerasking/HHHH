...
bool CDes::RunDes(bool bType, bool bMode, char* In, unsigned int uInDataLen,
		char* Out, unsigned int uOutDataLen, const char *Key,
		const unsigned char uKeyLen)
{
	...
	{	//ECB模式
		...
		case 1:
		{	//单Key
			for (int i = 0, j = uInDataLen >> 3; i < j; ++i, Out += 8, In += 8)
			{
...
/* 
 ...
 /*******************************************************************/
////////////////////////////////////////////////////////////////////////
bool CDes::RunPad(int nType, const char* In, unsigned int uDataLen, char* Out,
...
////////////////////////////////////////////////////////////////////////
bool CDes::Encrypt_Pad_PKCS_7(const char *Key, const unsigned char ucKeyLen,
		char* In, unsigned int uInDataLen, char* Out, unsigned int& uOutDataLen)
{
	//MB_CHECKF(
	CDes::RunPad(PAD_PKCS_7, In, uInDataLen, Out, uOutDataLen);
	//);

	return CDes::RunDes(ENCRYPT, CBC, Out, uOutDataLen, Out, uOutDataLen, Key,
			ucKeyLen);
}
////////////////////////////////////////////////////////////////////////
bool CDes::Decrypt_Pad_PKCS_7(const char *Key, const unsigned char ucKeyLen,
		char* In, unsigned int uInDataLen, char* Out, unsigned int& uOutDataLen)
{
	CDes::RunDes(DECRYPT, CBC, In, uInDataLen, Out, uOutDataLen, Key, ucKeyLen);
