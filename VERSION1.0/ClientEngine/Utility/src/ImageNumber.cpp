...
PictureNumber::PictureNumber()
{
	...
	for (unsigned int i = 0; i < sizeof(m_picSmallGreen) / sizeof(m_picSmallGreen[0]); i++) 
	{
...
void ImageNumber::SetBigGreenNumber(int number, bool bWithSign)
{
	...
	m_size.width = startPos + bits.size()*PictureNumber::SharedInstance()->GetBigRedSize().width;
...
void ImageNumber::SetSmallGreenNumber(int number, bool bWithSign)
{
	...
	m_size.width = startPos + bits.size()*PictureNumber::SharedInstance()->GetSmallRedSize().width;
	m_size.height = PictureNumber::SharedInstance()->GetSmallRedSize().height;
}
...
void ImageNumber::SetSmallGoldNumber(int num)
{
	...
	m_size.width = startPos + bits.size()*PictureNumber::SharedInstance()->GetSmallGoldSize().width;
