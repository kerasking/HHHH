...
void NDString::deepCopy(const NDString &src, char ** bufPtr, int *bufLenPtr)
{
...
NDString NDString::xorString(const NDString& str1, const NDString& str2)
{
...
map<int, NDString> NDString::split(const NDString& sp, bool bCut) const
{
	NDString dtVal;
