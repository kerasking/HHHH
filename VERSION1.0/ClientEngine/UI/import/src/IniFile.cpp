...
{
	m_strPath = newpath;
	NDLog("SetPath is %s", m_strPath.c_str());
}
...
bool CIniFile::ReadFile()
{
	...
	if (inifile == NULL)
	{
		NDError("Unable to open ini file.");
...
void CIniFile::GetPos(const char* keyname, const char* valuename, int* x,
		int* y)
{
