...
//
//	－－介绍－－
//	这两个数据存储类专门为NDUITableLayer对象提供数据集合
//	如果被NDUITableLayer对象使用了，无需手动释放，NDUITableLayer对象会帮助释放

#ifndef __NDDataSource_H
#define __NDDataSource_H
...
* begin
*/
//	class NDDataSource : public NDObject
//	{
//		DECLARE_CLASS(NDDataSource)
//		NDDataSource();
//		~NDDataSource();
//		
//	public:
...
//		NDDataSource* Copy();		
//	private:
//		std::vector<NDSection*> m_sections;
//	};
/***
* 临时性注释 郭浩
* end
