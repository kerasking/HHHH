...
class NDScrollLayer: public NDUILayer, public NDUILayerDelegate
{
...
protected:
	virtual bool refresh(float distance)
	{
		return true;
	}
	virtual bool refreshHorizonal(float distance)
	{
		return true;
	}
...
class NDUILabelScrollLayer: public NDScrollLayer
{
...
public:
	...
	void SetText(const char* text, unsigned int leftInterval = 0,
			unsigned int rightInterval = 0, unsigned int height = 0,
...
#pragma mark 
// ???
class NDUIContainerScrollLayer: public NDScrollLayer, public NDNodeDelegate
{
...
// ???
class NDUIContainerHScrollLayer: public NDScrollLayer
{
