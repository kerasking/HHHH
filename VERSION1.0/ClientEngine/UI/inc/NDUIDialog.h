...
namespace NDEngine
{
	...
	public:
		...
		void Show1(const char* title, const char* text, 
				   const char* op1);
		void Show2(const char* title, const char* text, 
				   const char* op1,
				   const char* op2);
		void Show3(const char* title, const char* text, 
				   const char* op1,
				   const char* op2,
				   const char* op3);
		void Show4(const char* title, const char* text, 
				   const char* op1,
				   const char* op2,
				   const char* op3,
				   const char* op4);
		void Show5(const char* title, const char* text, 
				   const char* op1,
				   const char* op2,
				   const char* op3,
				   const char* op4,
				   const char* op5);
		void Show6(const char* title, const char* text, 
				   const char* op1,
				   const char* op2,
				   const char* op3,
				   const char* op4,
				   const char* op5,
				   const char* op6);
		void Show7(const char* title, const char* text, 
				   const char* op1,
				   const char* op2,
				   const char* op3,
				   const char* op4,
				   ...
				   const char* op6,
				   const char* op7);
		void Show8(const char* title, const char* text, 
				   const char* op1,
				   const char* op2,
				   const char* op3,
				   const char* op4,
				   ...
				   const char* op7,
				   const char* op8);
		void Show9(const char* title, const char* text, 
				   const char* op1,
				   const char* op2,
				   const char* op3,
				   const char* op4,
				   ...
				   const char* op8,
				   const char* op9);
		void Show10(const char* title, const char* text, 
					const char* op1,
					const char* op2,
					const char* op3,
					const char* op4,
	...
	public:
		...
		void SetContent(const char *text, cocos2d::ccColor4B color=ccc4(79, 79, 79, 255), unsigned int fontsize=13);
	...
	protected:
		...
		enum { max_btns = 10, max_btns_half = 5, };
