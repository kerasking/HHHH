...
enum USERSTATE
{
	...
	USERSTATE_PRACTISE				= 0x40000,				// 打坐状态
};
...
enum BATTLE_TYPE
{
	...
	BATTLE_TYPE_MONSTER_PLAYBACK,	//普通战斗回放
    BATTLE_TYPE_SPORTS_PLAYBACK,    //竞技场战斗回放	
	BATTLE_TYPE_GROUP,
	//以下已不使用
...
enum BATTLE_EFFECT_TYPE
{
	...
	// 发起
	BATTLE_EFFECT_TYPE_ATK,				// 攻击/反击
	BATTLE_EFFECT_TYPE_SKILL,			// 技能(施放者)立即效果
	BATTLE_EFFECT_TYPE_SKILL_TARGET,	// 技能(承受者)立即效果
	...
	BATTLE_EFFECT_TYPE_CTRL,			//受控--暂不处理
	BATTLE_EFFECT_TYPE_ESCORTING,		//护驾//--显示文字特效而已
	BATTLE_EFFECT_TYPE_COOPRATION_HIT,	//合击//--显示文字特效而已
	BATTLE_EFFECT_TYPE_CHANGE_POSTION,	//移位//中军移动到后军==
    
	BATTLE_EFFECT_TYPE_SKILL_EFFECT_TARGET,	// 技能附加效果目标
	BATTLE_EFFECT_TYPE_SKILL_EFFECT,		// 技能附加效果
	BATTLE_EFFECT_TYPE_STATUS_MANA,			// 状态去气
	BATTLE_EFFECT_TYPE_RESIST,				// 免疫

	//目前仅客户端--2002-7-24
	BATTLE_EFFECT_TYPE_PLAY_ANIMATION,	//仅播放子动画
};

enum FIGHTER_ATK_TYPE
{
	FIGHTER_ATK_TYPE_NONE,
	FIGHTER_ATK_TYPE_PHY,			//武力近战
	FIGHTER_ATK_TYPE_PHY_DISTANCE,	//物理远战
	FIGHTER_ATK_TYPE_MAGIC,			//法术
};

#endif // end of define _GS_ENUM_DEFINE_H_3