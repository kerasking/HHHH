...
p.LayerRect = CGRectMake(winsize.w-btnw*1.5, winsize.h-btnh*CoordScaleY/2-40*ScaleFactor, btnw, btnh); 
...
function p.LoadUI(param1)
	...
	local btn	= CreateButton("button_look.png","button_look.png","",CGRectMake(0, 0, btnw*CoordScaleY/2, btnh*CoordScaleY/2),12);
