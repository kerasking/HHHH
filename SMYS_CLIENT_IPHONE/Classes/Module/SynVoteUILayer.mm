...
void VoteListCell::Initialization()
{
	...
	m_imgYes->SetPicture(pool.AddPicture(GetImgPathNew("request_ok.png")), true);
	m_imgYes->SetFrameRect(CGRectMake(330, 2, 23, 23));
	this->AddChild(m_imgYes);
	
	m_imgNo = new NDUIImage;
	m_imgNo->Initialization();
	m_imgNo->SetPicture(pool.AddPicture(GetImgPathNew("request_cancel.png")), true);
...
void SynVoteUILayer::Initialization()
{
	...
	m_btnView->SetBackgroundPicture(pool.AddPicture(GetImgPathNew("btn_bg1.png")), NULL, true, CGRectMake(3, 3, 38, 38), true);
	m_btnView->SetImage(pool.AddPicture(GetImgPathBattleUI("view_info.png")), false, CGRectZero, true);
	...
	m_btnCancelVote->SetBackgroundPicture(pool.AddPicture(GetImgPathNew("btn_bg1.png")), NULL, true, CGRectMake(7, 3, 38, 38), true);
	m_btnCancelVote->SetImage(pool.AddPicture(GetImgPathNew("cancel_vote.png")), true, CGRectMake(0, 2, 52, 44), true);
