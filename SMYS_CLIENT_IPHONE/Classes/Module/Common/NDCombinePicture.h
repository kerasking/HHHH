...
typedef enum
{
	...
	CombintPictureAligmentSelf			= CombintPictureAligmentBegin,		// 原位
	CombintPictureAligmentRight,											// 右侧
	CombintPictureAligmentRightDown,										// 右下
	CombintPictureAligmentDown,												// 下
	CombintPictureAligmentLeftDown,											// 左下
	CombintPictureAligmentLeft,												// 左
	CombintPictureAligmentLeftUp,											// 左上
	CombintPictureAligmentUp,												// 上
	CombintPictureAligmentRightUp,											// 右上
