...
const char* GetImgPathBattleUI(const char* fileName)
{
//	if ( IsTraditionalChinese() )
//	{	
//		return [[NSString stringWithFormat:@"%@/res/TraditionalImage/image/battle_ui/%@", [[NSBundle mainBundle] resourcePath], [NSString stringWithUTF8String:fileName]] UTF8String];
//	}
#ifdef TRADITION
	return [[NSString stringWithFormat:@"%@/TraditionalChineseRes/res/image/battle_ui/%@", [[NSBundle mainBundle] resourcePath], [NSString stringWithUTF8String:fileName]] UTF8String];
#else
	return [[NSString stringWithFormat:@"%@/SimplifiedChineseRes/res/image/battle_ui/%@", [[NSBundle mainBundle] resourcePath], [NSString stringWithUTF8String:fileName]] UTF8String];
#endif
}

const char* GetImgPath(const char* fileName)
{
//	if ( IsTraditionalChinese() )
//	{	
//		return [[NSString stringWithFormat:@"%@/res/TraditionalImage/image/%@", [[NSBundle mainBundle] resourcePath], [NSString stringWithUTF8String:fileName]] UTF8String];
//	}
#ifdef TRADITION	
	return [[NSString stringWithFormat:@"%@/TraditionalChineseRes/res/image/%@", [[NSBundle mainBundle] resourcePath], [NSString stringWithUTF8String:fileName]] UTF8String];
#else
	return [[NSString stringWithFormat:@"%@/SimplifiedChineseRes/res/image/%@", [[NSBundle mainBundle] resourcePath], [NSString stringWithUTF8String:fileName]] UTF8String];
#endif
}

const char* GetAniPath(const char* fileName)
{
#ifdef TRADITION
	return [[NSString stringWithFormat:@"%@/TraditionalChineseRes/res/animation/%@", [[NSBundle mainBundle] resourcePath], [NSString stringWithUTF8String:fileName]] UTF8String];
#else
	return [[NSString stringWithFormat:@"%@/SimplifiedChineseRes/res/animation/%@", [[NSBundle mainBundle] resourcePath], [NSString stringWithUTF8String:fileName]] UTF8String];
#endif
}

// 新界面资源统一放在 res/image/ui_new
const char* GetImgPathNew(const char* fileName)
{
//	if ( IsTraditionalChinese() )
//	{	
//		return [[NSString stringWithFormat:@"%@/res/TraditionalImage/image/ui_new/%@", [[NSBundle mainBundle] resourcePath], [NSString stringWithUTF8String:fileName]] UTF8String];
//	}
#ifdef TRADITION	
	return [[NSString stringWithFormat:@"%@/TraditionalChineseRes/res/image/ui_new/%@", [[NSBundle mainBundle] resourcePath], [NSString stringWithUTF8String:fileName]] UTF8String];
#else
	return [[NSString stringWithFormat:@"%@/SimplifiedChineseRes/res/image/ui_new/%@", [[NSBundle mainBundle] resourcePath], [NSString stringWithUTF8String:fileName]] UTF8String];
#endif
}
// 新界面高分辨率资源统一放在 res/image/ui_new/advance
const char* GetImgPathNewAdvance(const char* fileName)
{
//	if ( IsTraditionalChinese() )
//	{	
//		return [[NSString stringWithFormat:@"%@/res/TraditionalImage/image/ui_new/advance/%@", [[NSBundle mainBundle] resourcePath], [NSString stringWithUTF8String:fileName]] UTF8String];
//	}
#ifdef TRADITION	
	return [[NSString stringWithFormat:@"%@/TraditionalChineseRes/res/image/ui_new/advance/%@", [[NSBundle mainBundle] resourcePath], [NSString stringWithUTF8String:fileName]] UTF8String];
#else
	return [[NSString stringWithFormat:@"%@/SimplifiedChineseRes/res/image/ui_new/advance/%@", [[NSBundle mainBundle] resourcePath], [NSString stringWithUTF8String:fileName]] UTF8String];
#endif
}

const char* GetMapPath(const char* fileName)
{
//	if (IsSupportPrecisionPic()) 
//	{
//		return [[NSString stringWithFormat:@"%@/res/map/%@", [[NSBundle mainBundle] resourcePath], [NSString stringWithUTF8String:fileName]] UTF8String];
//	}
#ifdef TRADITION
	return [[NSString stringWithFormat:@"%@/TraditionalChineseRes/res/map/%@", [[NSBundle mainBundle] resourcePath], [NSString stringWithUTF8String:fileName]] UTF8String];
#else
	return [[NSString stringWithFormat:@"%@/SimplifiedChineseRes/res/map/%@", [[NSBundle mainBundle] resourcePath], [NSString stringWithUTF8String:fileName]] UTF8String];
#endif
}

const char* GetUIConfigPath(const char* filename)
{
#ifdef TRADITION
	return [[NSString stringWithFormat:@"%@/TraditionalChineseRes/res/UI/%@", [[NSBundle mainBundle] resourcePath], [NSString stringWithUTF8String:filename]] UTF8String];
#else
	return [[NSString stringWithFormat:@"%@/SimplifiedChineseRes/res/UI/%@", [[NSBundle mainBundle] resourcePath], [NSString stringWithUTF8String:filename]] UTF8String];
#endif
}

const char* GetUIImgPath(const char* uiFileNameWithPath)
{
#ifdef TRADITION
	return [[NSString stringWithFormat:@"%@/TraditionalChineseRes%@", [[NSBundle mainBundle] resourcePath], [NSString stringWithUTF8String:uiFileNameWithPath]] UTF8String];
#else
	return [[NSString stringWithFormat:@"%@/SimplifiedChineseRes%@", [[NSBundle mainBundle] resourcePath], [NSString stringWithUTF8String:uiFileNameWithPath]] UTF8String];
#endif
}

const char* GetResPath(const char* fileName)
{
#ifdef TRADITION
	return [[NSString stringWithFormat:@"%@/TraditionalChineseRes/res/%@", [[NSBundle mainBundle] resourcePath], [NSString stringWithUTF8String:fileName]] UTF8String];
#else
	return [[NSString stringWithFormat:@"%@/SimplifiedChineseRes/res/%@", [[NSBundle mainBundle] resourcePath], [NSString stringWithUTF8String:fileName]] UTF8String];
#endif
}
