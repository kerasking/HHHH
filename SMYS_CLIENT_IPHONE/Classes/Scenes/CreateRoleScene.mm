...
void CreateRoleScene::Initialization()
{
	...
	m_menuLayer->SetBackgroundImage(GetImgPathNew("createrole_bg.png"));
	m_menuLayer->SetFrameRect(CGRectMake(0, 0, winsize.width, winsize.height));
	layer->AddChild(m_menuLayer);
	
	NDPicture *picCreateRole = picpool.AddPicture(GetImgPathNew("create&login_text.png"));
...
//	m_menuLayer->AddChild(imgName);
	...
	layerRoleBg->SetBackgroundImage(picpool.AddPicture(GetImgPathNew("bg_sub_bg.png"), 480-32, 168), true);
	...
	NDPicture *picVerticalSplit = picpool.AddPicture(GetImgPathNew("bg_splitline_vertical.png"), 0, 160);
	...
	optSel = picpool.AddPicture(GetImgPathNew("left_sel_normal.png"));
	optUnSel = picpool.AddPicture(GetImgPathNew("left_sel_hightlight.png")); 
	optFocus = picpool.AddPicture(GetImgPathNew("bg_focus.png")); 
	for (int i = ePropSex; i <= eWeapon; i++) 
	{
		...
		NDPicture *picHorizontalSplit = picpool.AddPicture(GetImgPathNew("bg_splitline_horizontal.png"), 448-254-26);
...
//	layerRoleBg->SetFrameRect(CGRectMake(16, 85, 480-32, 128));
	...
	m_memoWeapon->SetBackgroundPicture(picpool.AddPicture(GetImgPathNew("bg_sub_bg.png"), 480-32, 49), true);
...
void CreateRoleScene::SetProptImage(int index, CGPoint orgin, NDUINode* parent)
{
	...
	NDPicture *picProp = picpool.AddPicture(GetImgPathNew("bg_property.png"));
	...
	NDPicture *picSel = picpool.AddPicture(GetImgPathNew("create&login_text2.png"));
