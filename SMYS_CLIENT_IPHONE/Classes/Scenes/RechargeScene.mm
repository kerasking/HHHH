...
void RechargeScene::Initialization()
{
	...
	NDPicture *picMoney = NDPicturePool::DefaultPool()->AddPicture(GetImgPath("emoney.png"));
...
{	
	...
	m_picEMoney = NDPicturePool::DefaultPool()->AddPicture(GetImgPath("emoney.png"));
