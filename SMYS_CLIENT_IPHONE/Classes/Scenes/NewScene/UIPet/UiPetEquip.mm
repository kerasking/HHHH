...
bool CUIPetEquip::Init()
{
	...
	NDPicture* pPicBg = pool.AddPicture(GetImgPathNew("bag_left_bg.png"));
	if (!pPicBg) {
		return false;
	}
	...
	NDPicture* picBtnL	= pool.AddPicture(GetImgPathNew("arrow_left.png"));
	...
	NDPicture* picBtnR	= pool.AddPicture(GetImgPathNew("arrow_right.png"));
	...
	NDPicture* pPicRoleBg = pool.AddPicture(GetImgPathNew("role_bg.png"), nRoleBgW, nRoleBgH);
	if (!pPicRoleBg) {
		return false;
	}
