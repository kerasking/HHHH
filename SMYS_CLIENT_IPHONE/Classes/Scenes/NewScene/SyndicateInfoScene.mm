...
void SyndicateInfoScene::Initialization(const string& strTabTitle, const string& strInfo)
{
	...
	tabnode->SetImage(pool.AddPicture(GetImgPathNew("newui_tab_unsel.png"), titleSize.width + 10, 31), 
					  pool.AddPicture(GetImgPathNew("newui_tab_sel.png"), titleSize.width + 10, 34),
	...
	bg->SetPicture(pool.AddPicture(GetImgPathNew("bag_bag_bg.png"), 480, 272), true);
	this->AddChild(bg);
