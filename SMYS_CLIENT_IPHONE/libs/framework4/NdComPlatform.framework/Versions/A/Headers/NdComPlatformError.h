...
#define ND_COM_PLATFORM_ERROR_PASSWORD_INVALID					-101				/**< 密码格式不合法，密码不能为空，长度为7－12个字符，由字母和数字组成，大小写敏感 */
...
#define ND_COM_PLATFORM_ERROR_NEW_PASSWORD_INVALID				-301				/**< 新密码格式非法，密码不能为空，长度为7－12个字符，由字母和数字组成，大小写敏感 */
