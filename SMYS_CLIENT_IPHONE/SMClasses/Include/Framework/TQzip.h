...
public:
	...
	static bool Compress(const char*pszSrcDir,const char*pszDestDir,const char*pszFileName,const char* pszNCFilter,ITQZipEvent *pTQZipEvent);
	...
	static bool UnCompress(const char*pszSrcFile,const char*pszDestDir,ITQZipEvent *pTQZipEvent);
