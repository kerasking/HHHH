...
//static void GenBounderRestLen(CRect& showRect,CRect& orgRect,int imgWidth,int imgHeight,int& left,int& top,int& right,int& bottom);
//static bool GetStretchBgRgn(CWndObject* lpWnd,int bgWidth,int bgHeight,CRect& showRect,CRect& bgRgn);


//static void DrawTextW(const wchar_t* lpText,CPoint& cntScreenOrg,CRect& showRect,CRect& cntRect,CPoint& viewOrg,int verAlign,int herAlign,int offSetX,int offSetY,bool isTextRender,unsigned int iColor,int iFontSize,int iWidth, bool isUnderLine=false,bool isBold=false);
//static void DrawMuliTextW(const wchar_t* lpText,CPoint& cntScreenOrg,CRect& showRect,CRect& cntRect,CPoint& viewOrg, int verAlign,int herAlign,int offSetX,int offSetY,bool isTextRender,unsigned int iColor,int iFontSize, bool widthSubOffSet=false);
