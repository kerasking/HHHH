...
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_K5			= 1049;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_K4			= 1048;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_K3			= 1047;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_K2			= 1046;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_K1			= 1024;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_J5			= 949;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_J4			= 948;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_J3			= 947;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_J2			= 946;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_J1			= 924;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_I5			= 849;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_I4			= 848;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_I3			= 847;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_I2			= 846;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_I1			= 824;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_H5			= 749;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_H4			= 748;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_H3			= 747;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_H2			= 746;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_H1			= 724;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_G5			= 649;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_G4			= 648;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_G3			= 647;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_G2			= 646;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_G1			= 624;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_F5			= 549;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_F4			= 548;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_F3			= 547;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_F2			= 546;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_F1			= 524;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_E5			= 449;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_E4			= 448;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_E3			= 447;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_E2			= 446;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_E1			= 424;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_D5			= 349;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_D4			= 348;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_D3			= 347;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_D2			= 346;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_D1			= 324;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_C5			= 249;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_C4			= 248;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_C3			= 247;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_C2			= 246;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_C1			= 224;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_B5			= 149;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_B4			= 148;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_B3			= 147;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_B2			= 146;
local ID_NORMALCOPY_M_CTRL_PICTURE_STAR_B1			= 124;
...
local TagStarList = {
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_B3,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_B2,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_B4,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_B1,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_B5,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_C3,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_C2,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_C4,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_C1,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_C5,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_D3,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_D2,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_D4,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_D1,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_D5,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_E3,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_E2,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_E4,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_E1,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_E5,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_F3,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_F2,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_F4,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_F1,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_F5,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_G3,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_G2,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_G4,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_G1,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_G5,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_H3,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_H2,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_H4,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_H1,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_H5,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_I3,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_I2,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_I4,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_I1,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_I5,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_J3,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_J2,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_J4,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_J1,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_J5,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_K3,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_K2,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_K4,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_K1,
	ID_NORMALCOPY_M_CTRL_PICTURE_STAR_K5,
}
...
function p.LoadUI(nParentMapId, nPassway, nBossId, nAim)
	LogInfo("mapId:%d nPassway:%d", nParentMapId,nPassway);
...
function p.showItemInfoDlg(nBossId, nAim)
	...
	if CheckP(lb) then
		...
		if CheckP(pic) then
			...
			lb:SetTag(TagTip);
			lb:SetFrameRect(CGRectMake(nX + 20*ScaleFactor, nY, size.w, size.h));
...
function p.refreshContainer()
	...
	for i = 1,  page do
		...
		for j = 1, 10 do 
			p.refreshItemView(view, lst[(i - 1) * 10 + j], j, (i - 1) * 10 + j);
		end
   end
end
...
function p.refreshItemView(view, t, index, lstIndex) 
	...
	if (t) then
		...
		if (not t.rank  or t.rank <= 0 ) then
			cleanV:SetVisible(false);
		end
	else
